 ...
 <%@page import="java.util.*"%>
                        ...
                        <table class="table-condensed" style="border-color: green; border-style: double; border-width: 5px; background-color:#ffffff;">
                            <tr>
                                <td colspan="3" align="center">
                                    <label class="form-control btn-success">Create Coach Account Form</label>
                                </td>
                            </tr>
                            <tr>
                                <td>ID</td>
    ...
    <option value="Outdoor.jsp">Outdoor</option>
                ...
                <tr>
                                <td>Game ID</td>
                                <td>
                                    <input type="text" name="GameId" size="30"  class="form-control" value="<%out.println(g1);%>" readonly="readonly">
                                </td>
                            </tr>
                            <tr>
                                <td>Experience(Year/Month)</td>
                                <td>
