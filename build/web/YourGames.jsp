...
<div id="tooplate_wrapper">
    ...
    <table class="box" align="center" border="1px" rules=columns width="650" style="background-color:#ffffff;"  id="tblMain"  >
		<tr style="background-color:#1f618d;color:white;">
			<th>User ID</th><th>Game ID</th><th>Coach ID</th><th>Plan</th>
		</tr>
            ...
            <%
                ...
                try
                {
                    int i=1;
                    Connection connection=Helper.connect();
                    PreparedStatement ps=connection.prepareStatement("select * from member where id='"+uid+"'");
                    ResultSet rs=ps.executeQuery();
                    while(rs.next())
                    {
                        %>
			...
			<tr>
                            ...
                            <% 
                            String NAcoach=rs.getString(3);
                            if(NAcoach==null)
                            {%>
                            <td align="center"><%out.print("No Coach");%></td>
                            <%
                            }
                            else
                            { %>
...
<%
					...
					}else if(act1.equals("Your Games"))
					{
						...
						<%
                                        ...
                                        else if(act1.equals("Your Coach"))
                                        {
