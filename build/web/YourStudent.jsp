...
<div id="tooplate_wrapper">
    	...
    	<div id="tooplate_sidebar">
            ...
            <div id="tooplate_content">
                ...
                <div class="col_b float_l">
                   ...
                   <h4><u><b>Find Your Student Details</b></u></h4>
            <table class="box"  align="center" rules=columns width="370"   id="tblMain"  >
    ...
    border: 1px solid #2d6898;" />
		...
		<tr style="background-color:#1f618d;color:white;">
			<th>Student ID</th><th>Student Name</th><th>Contact</th><th>Address</th><th>Email</th>
		</tr>
                <%
...
<%
					...
					}else if(act2.equals("Your Games"))
					{
						...
						<%
                                        ...
                                        else if(act2.equals("Your Student"))
                                        {
