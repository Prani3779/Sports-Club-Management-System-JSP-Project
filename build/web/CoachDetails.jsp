...
<div id="tooplate_wrapper">
    	...
    	<div id="tooplate_sidebar">
            ...
            <div id="tooplate_content">
                ...
                <div class="col_b float_l">
                    <div id="contact_form">
                       <form method="post" >
                           <table class="box"  align="center" rules=columns width="650"   id="tblMain"  >
                               <tr><TD align="center"><b>Coach ID:</b></TD>
                                    <TD>
                                    <INPUT TYPE="TEXT" NAME="txtcid" SIZE="25">
                                    </TD>
    ...
    border: 1px solid #2d6898;" />
		...
		<tr style="background-color:#1f618d;color:white;">
			<th>Coach ID</th><th>Coach Name</th><th>Game ID</th><th>Fess</th><th>Experince</th>
		</tr>
                <%
                                               txtgmid=request.getParameter("txtid");
                                             coachid=request.getParameter("txtcid");
                                              try
                {
                    int i=1;
                    
                    Connection connection=Helper.connect();
                    PreparedStatement ps=connection.prepareStatement("select * from coach where id='"+coachid+"' and game_id='"+txtgmid+"'");
                    ResultSet rs=ps.executeQuery();
                    while(rs.next())
                    {
                        %>
			...
			<tr>
                ...
                <tr>
                   ...
                   <h4><u><b>Find Your Coach Details</b></u></h4>
            <table class="box"  align="center" rules=columns width="350"   id="tblMain"  >
                               
                           
                <tr>
                                   <TD align="left"><b>Coach ID:</b></TD>
                                    <TD>
                                    <INPUT TYPE="TEXT" NAME="ctxtid" SIZE="25">
                                    </TD>
                                   
                                       <td align="left">
                                           <input type="submit" value="search" id="submit" name="sc" class="submit_btn float_l" style=" display: inline-block;
    text-decoration: none;
    color: #fff;
    font-weight: bold;
    background-color:black;
    ...
    border: 1px solid #2d6898;" />
            ...
            <%  }  %>
                ...
                String act1=request.getParameter("sc");
					...
					if(act1 == null){
                                        ...
                                        else if(act1.equals("search"))
					{%>
             <table class="box" align="center" border="1px" rules=columns width="650" style="background-color:#ffffff;"  id="tblMain"  >
		<tr style="background-color:#1f618d;color:white;">
			<th>Coach ID</th><th>Coach Name</th><th>Contact</th><th>Address</th><th>Email</th>
		</tr>
                <%
                                               txtgmid1=request.getParameter("ctxtid");
                                              ...
                                              try
                {
                    ...
                    Connection connection=Helper.connect();
                    PreparedStatement ps=connection.prepareStatement("select id,name,contact,address,email from exm where id='"+txtgmid1+"'");
                    ResultSet rs=ps.executeQuery();
                    while(rs.next())
                    {
                        %>
...
<%
					String act2=request.getParameter("P");
					if(act2 == null){
						
					}else if(act2.equals("Payment Details"))
					{
						%>
                                               <% 
					...
					}else if(act2.equals("Your Games"))
					{
						%>
						  <% 
						...
						<%
                                        ...
                                        else if(act2.equals("Your Coach"))
                                        {
