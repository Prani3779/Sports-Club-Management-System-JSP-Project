...
<body style="height: 650px;
  ...
  background-image: linear-gradient(to right,#000000,#004080,#000000); ">
    ...
    if (r == true) {
        ...
        var jspcall = "newCoachForm.jsp?cur_id="+vals;
 ...
 function ActionFunction() {
    ...
    <form method="post" >
    <table class="box" align="center" border="1px" rules=columns width="850" style="background-color:#ffffff;"  id="tblMain"  >
		<tr style="background-color:#1f618d;color:white;">
			<th>Game ID</th><th>Game Name</th><th>Time</th><th>Type</th><th>Select</th>
		</tr>
