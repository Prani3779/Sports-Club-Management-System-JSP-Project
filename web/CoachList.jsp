...
<body>
    ...
    if (r == true) {
        ...
        var jspcall = "ConfirmGames.jsp?coach_id="+vals;
 ...
 function ActionFunction() {
    ...
    <form method="post" >
    <table class="box" align="center" border="1px" rules=columns width="800" >
		<tr style="background-color:#1f618d;color:white;">
			<th>Coach ID</th><th>Coach Name</th><th>Experience</th><th>Fee</th><th>Select</th>
		</tr>
       ...
       <%
            ...
            <%
                ...
                try
                {
                    ...
                    PreparedStatement ps=connection.prepareStatement("select * from coach where game_id=?");
                                                          ps.setString(1,ram);
                    //PreparedStatement ps=connection.prepareStatement("select * from coach");
