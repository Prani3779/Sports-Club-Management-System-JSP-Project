...
<body>
    ...
    <form action="AdminGames.jsp" method="post">
			<table align="center" border="0" width="650px">
				
				<tr style="background-color: #555555;color:white;"><td align="right">Game ID</td><td align="right"><input type="text" name="selectDate" /></td><td></td><td><input type="submit" value="Search" name="btn2" class="button button2"></td><td  align="center"></td></tr>
			</table>
...
<table align="center" border="1" width="1180px" style="border-collapse:collapse;">
    <tr style="background-color:yellowgreen;color:white;"><th><b>Game_ID</b></th><th><b>Game_Name</b></th><th><b>Time</b></th><th><b>Price</b> </th><th><b>Type</b></th><th><b>Seat</b></th>
		...
		if(f==1)
		{
			...
			try
			{
	            ...
	            Statement statement = con.createStatement(); 
	            ResultSet resultset =  statement.executeQuery("select * from games where game_id='"+cdate+"'") ; 
	            while(resultset.next())
	            {
	            	 out.print("<tr>");
	            	 out.print("<td>"+resultset.getString(1)+"</td>");
...
<!-- Trigger/Open The Modal -->
   ...
   <table border="0px">
	  <tr>
		...
		<TD><b>Time:</b></TD>
		    <TD>
		      <INPUT TYPE="TEXT" NAME="Time" SIZE="35"  required>
		    </TD>
		</tr>
                <tr>
		<TD><b>Price:</b></TD>
		    <TD>
		      <INPUT TYPE="TEXT" NAME="Price" SIZE="35"  required>
		    </TD>
		</tr>
		<tr>
		<TD><b>Type:</b></TD>
		<TD><b><LABEL><INPUT TYPE="RADIO" NAME="eGender" VALUE="Indoor">Indoor
		</label>&nbsp;&nbsp;&nbsp;<LABEL><INPUT TYPE="RADIO" NAME="eGender" VALUE="Outdoor">Outdoor</label>
		</b></td>
		</tr>
		<tr><TD><b>Seat:</b></TD>
		    <TD>
 ...
 <div id="myModal" class="modal">
	<form method="post" action="GameDelete.jsp">
        <!-- Modal content -->
        <div class="modal-header">
				<span class="close close_multi">×</span>
				<h2>Delete Game</h2>
...
// When the user clicks on <span> (x), close the modal
    ...
    <form  method="post" action="AdminGames.jsp">  
 <table align="center" border="0" width="550px">
				
				<tr><th align="right">Game ID</th><th align="right"><input type="text" name="eid" /></th><th><input type="submit" value="Search For Update" name="srch" class="button button2"></th></tr>
				</form>
			 ...
			 <% 
				...
				if(act_new == null){
					...
					session.setAttribute("admingid",request.getParameter("eid"));
					try {
						Connection connection=Helper.connect();
                                                String query = "select * from games where game_id='"+request.getParameter("eid")+"'";
					Statement st = connection.createStatement();
					ResultSet rs = st.executeQuery(query);
					if(rs.next()){
					%>
					
					<tr><td>Game ID</td><td colspan="2"><%=rs.getString(1)%></td></tr>
					<tr><td>Game Name</td><td colspan="2"><%=rs.getString(2)%></td></tr>
					<tr><td>Time</td><td colspan="2"><input type="text" name="time" value="<%=rs.getString(3)%>"></td></tr>
					<tr><td>Price</td><td colspan="2"><input type="text" name="cont" value="<%=rs.getString(4)%>"></td></tr>
					<tr><td>Type</td><td colspan="2"><%=rs.getString(5)%></td></tr>
					<tr><td>Seat</td><td colspan="2"><input type="text" name="Seat" value="<%=rs.getString(6)%>"></td></tr>
