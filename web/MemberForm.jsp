    ...
    session.setAttribute("gmid",g1);  %>
		...
		<TD>Game Type:</TD>
		    <TD>
			  ...
			  <select name="games" onchange="if (this.value) window.location.href=this.value">
    <option value="">Select Game Type</option>
    <option value="MemberGame.jsp">Indoor</option>
    <option value="MoutGames.jsp">Outdoor</option>
</select>	
